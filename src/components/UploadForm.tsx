...
const UploadForm = () => {
          ...
          rejectedFiles
            .flatMap((file) => {
              if (
                ...
                return [
                  'File is too large. (Maximum file size is 4MB). Try loading via URL instead of file upload, or use GTFS-to-blocks library from the command line.',
                ];
              }
  ...
  return (
    <>
      <h2 className="text-center">Generate CSV of blocks from GTFS</h2>
      {success ? (
